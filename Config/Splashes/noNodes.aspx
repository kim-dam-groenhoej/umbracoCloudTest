        ...
        <div>
            ...
            <div>
                ...
                <div ng-if="vm.restore.status === ''">
                    ...
                    <h1 ng-if="!vm.isDebug">Initializing...</h1>
                    <small ng-if="!vm.isDebug">Please wait while your site is initialized</small>
                    ...
                    <h1 ng-if="vm.isDebug">Initializing your site...</h1>
                    <small ng-if="vm.isDebug">Press the button below to begin</small>
                    <div class="cta" ng-if="vm.isDebug">
